...
public class FinalStats {
    ...
    public FinalStats() {
        ...
        if(UndercastConfig.realtimeStats) {
            this.totalKD = "\u00A7f Total: \u00A73" + 
                    (((UndercastData.kills + UndercastData.stats.kills)/(UndercastData.deaths + UndercastData.stats.deaths)));
            try {
    ...
    public void showStats() {
        ...
        player.addChatMessage("\u00A76\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-");
        player.addChatMessage("Kills: \u00A7a" + this.kills + ((mod_Undercast.CONFIG.realtimeStats) ? ("\u00A7f Total: \u00A7a" + this.totalKills) : ""));
        player.addChatMessage("Deaths: \u00A74" + this.deaths + ((mod_Undercast.CONFIG.realtimeStats) ? ("\u00A7f Total: \u00A74" + this.totalDeaths) : ""));
        player.addChatMessage("K/D: \u00A73" + this.kd + totalKD);
        player.addChatMessage("Kill Streak: \u00A7e" + this.killstreak);
        if(this.woolDifference > 0) {
            player.addChatMessage("Wools: \u00A75+" + this.woolDifference + ((mod_Undercast.CONFIG.realtimeStats) ? ("\u00A7f Total: \u00A75" + this.totalWools) : ""));
        }
        if(this.coreDifference > 0) {
            player.addChatMessage("Cores: \u00A75+" + this.coreDifference + ((mod_Undercast.CONFIG.realtimeStats) ? ("\u00A7f Total: \u00A75" + this.totalCores) : ""));
        }
        if(this.monumentDifference > 0) {
            player.addChatMessage("Monuments: \u00A75+" + this.monumentDifference + ((mod_Undercast.CONFIG.realtimeStats) ? ("\u00A7f Total: \u00A75" + this.totalMonuments) : ""));
        }
        player.addChatMessage("\u00A76\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-\u00A7m-");
    }
}
